...
glossary:
  ...
  backend: The {{< glossary term="server-side" displayTerm="server-side" >}}/behind-scenes of an application that is responsible for processing requests, interacting with databases, and generating responses to be sent to the {{< glossary term="client" displayTerm="client" >}} ({{< glossary term="frontend" displayTerm="frontend" >}}).
  ...
  client: A device or software that accesses services or resources provided by a {{< glossary term="server" displayTerm="server" >}} by making requests. Clients can be website/browsers, mobile applications, desktop applications, etc.

  Client-Side: Things that happen on the {{< glossary term="client" displayTerm="client" >}}, e.g., rendering of the {{< glossary term="user-interface" displayTerm="user-interface" >}}, handling user interactions and events, sending requests to the server, computing, etc.

  css: Test {{< glossary term="Cascading" displayTerm="Cascading" >}} {{< glossary term="Style-Sheet-Language" displayTerm="Style Sheets" >}} is a style sheet language used for describing and styling the presentation of a document written in HTML. CSS describes how elements should be rendered on screen, on paper, in speech, or on other media. E.g., changing the color, font, size, spacing, positioning, and layout of elements on a web page.
  ...
  frontend: The client-side/front-scenes of a application that is responsible for rendering the user interface and sending requests to the server ({{< glossary term="backend" displayTerm="backend" >}}) for processing.
  ...
  Style-Sheet-Language: A language used to describe the presentation or formatting of a document written in a {{< glossary term="markup-language" displayTerm="markup language" >}} like {{< glossary term="HTML" displayTerm="HTML" >}}, typically defining how elements should be displayed or rendered across different media.
...
Client-Side
: Things that happen on the {{< glossary term="client" >}}, e.g., rendering of the {{< glossary term="user-interface" >}}, handling user interactions and events, sending requests to the server, computing, etc.
